...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#E8E8E8] via-[#A4B8D8] via-[#8BA3C8] via-[#A4B8D8] to-[#E8E8E8]">
      ...
      <motion.div
        className="relative pt-32 pb-4 lg:pt-32 lg:pb-12"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        <div className="mx-auto max-w-5xl px-4 flex flex-col lg:flex-row-reverse items-start justify-center gap-8 lg:gap-16">
          ...
          <div className="block lg:hidden w-full">
            <div className="text-center mb-10">
              <h1 className="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-1">Learning the Guitar</h1>
            ...
            <div className="flex flex-row items-center justify-center gap-2 mb-10">
              <Link
                href="/lessons"
                className="rounded-md bg-background px-6 py-3 text-base font-semibold text-white shadow-[0_0_15px_rgba(69,67,73,0.3)] hover:shadow-[0_0_20px_rgba(69,67,73,0.4)] transition-all duration-300"
              >
                Book a Lesson
              </Link>
              <Link
                href="/shop"
                className="text-base font-semibold text-background hover:text-[#6B7280] px-6 py-3 rounded-md transition-colors"
              >
