    ...
    >
      ...
      <div 
        className={`absolute inset-0 bg-black transition-opacity duration-300 ${
          isVisible ? 'opacity-50 backdrop-blur-sm' : 'opacity-0'
        }`}
        onClick={onClose}
      />
      ...
      {/* Dialog */}
      <div 
        className={`relative bg-gradient-to-br from-gray-200 via-gray-300 to-gray-400 rounded-lg max-w-md w-full p-6 transform transition-all duration-300 ${
      ...
      >
        ...
        <h2 className="text-2xl font-bold text-gray-900 mb-6">Say Hello</h2>
